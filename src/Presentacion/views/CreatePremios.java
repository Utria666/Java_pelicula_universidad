...
public class CreatePremios extends javax.swing.JPanel {
    ...
    public CreatePremios(Dashboard dashboard) {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        boolean exito = premioPeliculaService.registrarPremioPelicula(idPremios, idPeliculas, nombreCertemen, ciudad);

            if (exito) {
                JOptionPane.showMessageDialog(this, "Premio asignado con éxito.", "Registro Exitoso", JOptionPane.INFORMATION_MESSAGE);
                limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, "Error al crear un premio.", "Error de Registro", JOptionPane.ERROR_MESSAGE);
            }
        }
